                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?=
                                                        $hoje  ?>" type="datetime-local" class="form-control" name="data_inicio" required>
                                    </div>
                                </div>
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?=
                                                        $dt_fim ?>" type="datetime-local" class="form-control" name="data_fim" required>
                                    </div>
                                </div>
